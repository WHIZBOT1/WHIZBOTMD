...
const questions = [
  ...
  "Would you rather wash your hair with mashed potatoes or cranberry sauce?",
  "Would you rather team up with Wonder Woman or Captain Marvel?",
  "Would you rather find true love or win the lottery next month?",
  ...
  "Would you rather live low life with your loved one or a rich life all alone?",
  ...
  "Would you rather end the life of a single human being or 100 cute baby animals?",
  ...
  "Would you rather play Minecraft or play FIFA?",
...
smd(
  ...
  async (m) => {
    ...
    m.reply(`*Would You Rather:* ${randomQuestion}`);
  }
);
